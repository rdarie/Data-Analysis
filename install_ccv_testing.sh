...
read FILLER
chmod +x $HOME/anaconda/nda3/bin/*
conda activate nda3
cd ..
export PYTHONPATH="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages"
#
pip install pyqt5==5.10.1 --target="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --upgrade
...
pip install vg==1.6.1 --target="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --no-deps
# pip install vtk==8.1.0 --target="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --no-deps --dry-run
...
# pip install importlib-resources --target="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --no-deps

pip install git+git://github.com/G-Node/nixpy@v1.5.0b3 --target="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --no-deps
...
for i in ${RepoList[*]}; do
    ...
    python setup.py develop --install-dir="/users/rdarie/anaconda/nda3/lib/python3.7/site-packages" --no-deps
    cd ..
done
#
cd Data-Analysis
