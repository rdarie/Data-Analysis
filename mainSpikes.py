...
if __name__ == '__main__':
    ...
    if plotting:
        ...
        ax = fi.axes[0]
        ax.plot(binCenters[upMaskSpikes], dummyVar[upMaskSpikes], 'ro', label = 'Foot Up')
        ax.plot(binCenters[downMaskSpikes], dummyVar[downMaskSpikes] + 1, 'go', label = 'Foot Strike')

        ax.plot(binCenters[upMaskSpikesPredicted], dummyVar[upMaskSpikesPredicted] + .5, 'mo', label = 'Decoded Foot Up')
        ax.plot(binCenters[downMaskSpikesPredicted], dummyVar[downMaskSpikesPredicted] + 1.5, 'co', label = 'Decoded Foot Strike')
        ax.legend()
