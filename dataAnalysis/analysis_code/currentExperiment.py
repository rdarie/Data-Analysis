...
customSeabornContexts = {
    'talk': {
        ...
        'font.size': 10., 'axes.labelsize': 14., 'axes.titlesize': 14.,
    ...
    'paper': {
        ...
        'font.size': 5., 'axes.labelsize': 6., 'axes.titlesize': 7.,
...
def parseAnalysisOptions(
    ...
    prettyNameLookup = {
        ...
        'cohen-d': 'Cohen\'s d',
        'coef': r"$\beta$",
        'coefStd': 'Standardized regression coefficient',  # \n({})'.format(r"$\beta$")
        ...
        'feature = mahal_ledoit_all': 'Broadband\nmh. dist.',
        ...
        'trialAmplitude_md': 'Stim. amplitude',
        'trialAmplitude:trialRateInHz_md': 'Stim. rate interaction',
        'stimCondition = NA_0.0': 'No stim.',
