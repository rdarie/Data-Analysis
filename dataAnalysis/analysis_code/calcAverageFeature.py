...
if __name__ == '__main__':
    ...
    #
    chosenEstimator = tdr.DataFrameColumnAverager(
        groupBy=['freqBandName', 'lag'],
        metaDataFiller={'feature': 'averageSignal', 'xCoords': 0, 'yCoords': 0, 'parentFeature': 'averageSignal#0'})
    chosenEstimator.fit(dataDF)
    featuresDF = chosenEstimator.transform(dataDF)
    # pdb.set_trace()
    ...
    outputLoadingMeta['arguments']['unitQuery'] = outputSelectionName
