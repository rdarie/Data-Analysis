...
def getExpOpts():
    ...
    experimentName = '202012151200-Rupert'
    ...
    jsonSessionNames = {
        #  per trial
        1: [],
        2: ['Session1608052663053', 'Session1608052941424']
        }
    ...
    spikeSortingOpts = {
        'utah': {
            ...
            'rawBlockName': 'utah',
            'excludeChans': [
                'utah9', 'utah20', 'utah19', 'utah29', 'utah39',
                'utah49', 'utah40', 'utah30', 'utah1', 'utah96',
                'utah10', ],
            'prbOpts': dict(
                contactSpacing=400,
                groupIn={
