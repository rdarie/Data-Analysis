...
# Specify a job name:
#SBATCH -J s14a_temp_mahal_dist_rauc_2021

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s14a_temp_mahal_dist_rauc_2021.out
#SBATCH -e ../../batch_logs/covariance/s14a_temp_mahal_dist_rauc_2021.out
