...
# Specify a job name:
#SBATCH -J s02c_tts_plots_stim_2019

# Specify an output file
#SBATCH -o ../../batch_logs/s02c_test_train_split_plots_stim_2019-%a.out
#SBATCH -e ../../batch_logs/s02c_test_train_split_plots_stim_2019-%a.out
