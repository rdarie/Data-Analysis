...
# Specify a job name:
#SBATCH -J s12b_apply_baseline_motion_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/s12b_apply_baseline_motion_202101_20-%a.out
#SBATCH -e ../../batch_logs/s12b_apply_baseline_motion_202101_20-%a.out
