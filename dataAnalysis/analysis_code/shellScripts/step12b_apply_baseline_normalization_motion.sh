...
# Specify a job name:
#SBATCH -J s12b_apply_baseline_motion_2019

# Specify an output file
#SBATCH -o ../../batch_logs/s12b_apply_baseline_motion_2019-%a.out
#SBATCH -e ../../batch_logs/s12b_apply_baseline_motion_2019-%a.out
