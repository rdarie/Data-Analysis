...
# Specify a job name:
#SBATCH -J s13c_apply_mahal_dist_stim_202101_27

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s13c_apply_mahal_dist_stim_202101_27-%a.out
#SBATCH -e ../../batch_logs/covariance/s13c_apply_mahal_dist_stim_202101_27-%a.out
