...
# Specify a job name:
#SBATCH -J test_train_assembler_regression_25

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_assembler_regression_25.out
#SBATCH -e ../../batch_logs/test_train_assembler_regression_25.out
