...
#SBATCH -o ../../batch_logs/%j-%a-compare_covariances_28.out
#SBATCH -e ../../batch_logs/%j-%a-compare_covariances_28.out
...
do
  python -u './calcSignalCovarianceMatrix.py' --estimatorName="mahal" --datasetName="Block_${WINDOWTERM}_df_${ITER}" --selectionName=$TARGET --exp=$EXP $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR --verbose=2 --plotting
done
#
