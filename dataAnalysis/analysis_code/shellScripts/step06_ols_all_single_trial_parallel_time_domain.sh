...
# Specify a job name:
#SBATCH -J s06_ols_stb_202101_21

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s06_ols_stb_202101_21-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s06_ols_stb_202101_21-%a.out
