...
python -u './applyTestTrainSplit.py' --inputBlockSuffix="rig" --unitQuery="jointAngularVelocity" --selectionName='jointAngularVelocity' --verbose --iteratorSuffix='a' --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR $LAZINESS
