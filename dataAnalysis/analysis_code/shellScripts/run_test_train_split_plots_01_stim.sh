...
# Specify a job name:
#SBATCH -J test_train_split_plots_stim_21

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_split_plots_stim_21-%a.out
#SBATCH -e ../../batch_logs/test_train_split_plots_stim_21-%a.out
