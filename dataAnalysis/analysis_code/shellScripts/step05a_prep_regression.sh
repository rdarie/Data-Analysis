...
# Specify a job name:
#SBATCH -J s05a_prep_regression_rc_202101_22

# Specify an output file
#SBATCH -o ../../batch_logs/regression/s05a_prep_regression_rc_202101_22.out
#SBATCH -e ../../batch_logs/regression/s05a_prep_regression_rc_202101_22.out
