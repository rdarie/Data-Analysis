...
# Specify a job name:
#SBATCH -J tts_norm_motion_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_split_normalization_motion_202101_20-%a.out
#SBATCH -e ../../batch_logs/test_train_split_normalization_motion_202101_20-%a.out
