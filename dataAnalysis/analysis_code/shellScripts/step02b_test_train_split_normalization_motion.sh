...
# Specify a job name:
#SBATCH -J s02b_tts_norm_motion_2021

# Specify an output file
#SBATCH -o ../../batch_logs/s02b_test_train_split_normalization_motion_2021-%a.out
#SBATCH -e ../../batch_logs/s02b_test_train_split_normalization_motion_2021-%a.out
