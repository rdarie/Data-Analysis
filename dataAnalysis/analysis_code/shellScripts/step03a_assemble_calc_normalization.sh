...
# Specify a job name:
#SBATCH -J s03a_assemble_normalize_202102_02

# Specify an output file
#SBATCH -o ../../batch_logs/s03a_assemble_normalize_202102_02.out
#SBATCH -e ../../batch_logs/s03a_assemble_normalize_202102_02.out
