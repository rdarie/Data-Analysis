...
# Specify a job name:
#SBATCH -J s03a_assemble_normalize_202101_27

# Specify an output file
#SBATCH -o ../../batch_logs/s03a_assemble_normalize_202101_27.out
#SBATCH -e ../../batch_logs/s03a_assemble_normalize_202101_27.out
