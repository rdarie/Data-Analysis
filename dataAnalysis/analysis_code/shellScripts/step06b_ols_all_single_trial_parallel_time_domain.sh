...
# Specify a job name:
#SBATCH -J s06b_ols_rc_td_202101_22

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s06b_ols_rc_td_202101_22-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s06b_ols_rc_td_202101_22-%a.out
