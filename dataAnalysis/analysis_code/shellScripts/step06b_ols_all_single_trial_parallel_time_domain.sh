...
# Specify a job name:
#SBATCH -J s06b_ols_sta_td_202101_21

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s06b_ols_sta_td_202101_21-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s06b_ols_sta_td_202101_21-%a.out
