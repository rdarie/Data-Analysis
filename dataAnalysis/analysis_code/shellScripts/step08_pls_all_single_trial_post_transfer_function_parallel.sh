...
# Specify a job name:
#SBATCH -J s08_pls_tf_sta_201901_27

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s08_pls_tf_sta_201901_27-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s08_pls_tf_sta_201901_27-%a.out
