...
# Specify a job name:
#SBATCH -J s02c_get_tts_control_202101_28

# Specify an output files
#SBATCH -o ../../batch_logs/covariance/s02c_get_tts_control_202101_28-%a.out
#SBATCH -e ../../batch_logs/covariance/s02c_get_tts_control_202101_28-%a.out
