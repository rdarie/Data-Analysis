...
# Specify a job name:
#SBATCH -J s02c_get_tts_control_202101_p2

# Specify an output files
#SBATCH -o ../../batch_logs/covariance/s02c_get_tts_control_202101_p2-%a.out
#SBATCH -e ../../batch_logs/covariance/s02c_get_tts_control_202101_p2-%a.out
...
exps=(202101_25 202101_27 202101_28 202102_02)
for A in "${exps[@]}"
do
