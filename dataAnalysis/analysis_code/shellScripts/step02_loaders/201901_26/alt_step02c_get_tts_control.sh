...
# Specify a job name:
#SBATCH -J s02c_get_tts_control_201901_26

# Specify an output files
#SBATCH -o ../../batch_logs/covariance/s02c_get_tts_control_201901_26-%a.out
#SBATCH -e ../../batch_logs/covariance/s02c_get_tts_control_201901_26-%a.out
