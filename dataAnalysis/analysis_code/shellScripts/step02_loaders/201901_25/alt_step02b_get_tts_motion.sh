...
# Specify a job name:
#SBATCH -J s02b_get_tts_motion_201901_25

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s02b_get_tts_motion_201901_25-%a.out
#SBATCH -e ../../batch_logs/covariance/s02b_get_tts_motion_201901_25-%a.out
