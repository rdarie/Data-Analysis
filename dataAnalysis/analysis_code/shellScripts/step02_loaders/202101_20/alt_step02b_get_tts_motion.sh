...
# Specify a job name:
#SBATCH -J s02b_get_tts_motion_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s02b_get_tts_motion_202101_20-%a.out
#SBATCH -e ../../batch_logs/covariance/s02b_get_tts_motion_202101_20-%a.out
