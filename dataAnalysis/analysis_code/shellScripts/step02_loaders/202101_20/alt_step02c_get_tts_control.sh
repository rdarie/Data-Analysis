...
# Specify a job name:
#SBATCH -J s02c_get_tts_control_202101_20

# Specify an output files
#SBATCH -o ../../batch_logs/covariance/s02c_get_tts_control_202101_20-%a.out
#SBATCH -e ../../batch_logs/covariance/s02c_get_tts_control_202101_20-%a.out
