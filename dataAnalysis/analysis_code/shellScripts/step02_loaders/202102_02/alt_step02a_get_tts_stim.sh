...
# Specify a job name:
#SBATCH -J s02a_get_tts_stim_202102_02

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s02a_get_tts_stim_202102_02-%a.out
#SBATCH -e ../../batch_logs/covariance/s02a_get_tts_stim_202102_02-%a.out
