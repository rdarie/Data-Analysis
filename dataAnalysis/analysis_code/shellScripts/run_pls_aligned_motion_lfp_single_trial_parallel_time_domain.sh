...
# Specify a job name:
#SBATCH -J pls_motion_lfp_ste_27

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/pls_regression_lfp_ste_27-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/pls_regression_lfp_ste_27-%a.out
