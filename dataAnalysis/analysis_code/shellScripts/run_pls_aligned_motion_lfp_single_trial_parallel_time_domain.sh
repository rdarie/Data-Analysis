...
# Specify a job name:
#SBATCH -J pls_motion_lfp_sta_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/pls_regression_lfp_sta_202101_20-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/pls_regression_lfp_sta_202101_20-%a.out
