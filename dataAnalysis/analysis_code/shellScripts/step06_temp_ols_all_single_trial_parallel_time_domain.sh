...
# Specify a job name:
#SBATCH -J s06_ols_sta_202101_25

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s06_ols_sta_202101_25-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s06_ols_sta_202101_25-%a.out
