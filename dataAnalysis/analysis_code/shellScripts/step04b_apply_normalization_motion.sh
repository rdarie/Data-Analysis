...
# Specify a job name:
#SBATCH -J s04b_apply_norm_motion_lfp_201902

# Specify an output file
#SBATCH -o ../../batch_logs/s04b_apply_norm_motion_lfp_201902-%a.out
#SBATCH -e ../../batch_logs/s04b_apply_norm_motion_lfp_201902-%a.out
