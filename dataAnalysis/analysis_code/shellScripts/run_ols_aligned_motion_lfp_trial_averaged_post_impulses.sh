...
# Specify a job name:
#SBATCH -J ols_motion_lfp_post_impulses_ta_27

# Specify an output file
#SBATCH -o ../../batch_logs/ols_motion_lfp_post_impulses_ta_27.out
#SBATCH -e ../../batch_logs/ols_motion_lfp_post_impulses_ta_27.out
