...
# Specify a job name:
#SBATCH -J s05b_prep_regression_rc_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/regression/s05b_prep_regression_rc_202101_20.out
#SBATCH -e ../../batch_logs/regression/s05b_prep_regression_rc_202101_20.out
...
do
  ...
  #--------------------------------------------------#
  python -u './calcSignalColumnSelector.py'  --selectMethod='fromRegression' --estimatorName="${DIMRED}" --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}" --selectionName=$TARGET --exp=$EXP $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR --verbose=2 --plotting
  #--------------------------#
