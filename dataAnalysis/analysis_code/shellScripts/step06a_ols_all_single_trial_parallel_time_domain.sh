...
# Specify a job name:
#SBATCH -J s06a_ols_rc_201902_03

# Specify an output file
#SBATCH -o ../../batch_logs/regression/job_arrays/s06a_ols_rc_201902_03-%a.out
#SBATCH -e ../../batch_logs/regression/job_arrays/s06a_ols_rc_201902_03-%a.out
