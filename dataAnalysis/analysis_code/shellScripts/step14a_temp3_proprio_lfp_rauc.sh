...
# Specify a job name:
#SBATCH -J s14a_mahal_dist_rauc_202101_25

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s14a_mahal_dist_rauc_202101_25.out
#SBATCH -e ../../batch_logs/covariance/s14a_mahal_dist_rauc_202101_25.out
...
do
  ...
  python -u "./calcOutliersFromSignalRecruitment.py" --iteratorSuffix=$ITERATOR --plotting --exp=$EXP $BLOCKSELECTOR $WINDOW $ANALYSISFOLDER --loadFromFrames --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}" --selectionName=$TARGET
  #
  ...
  INPUTBLOCKNAME="--inputBlockSuffix=${TARGET} --inputBlockPrefix=Block"
  #
  python -u "./calcSignalRecruitmentV4.py" --iteratorSuffix=$ITERATOR --exp=$EXP $BLOCKSELECTOR $WINDOW $ANALYSISFOLDER --loadFromFrames --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}" --selectionName=$TARGET
  python -u "./plotSignalRecruitmentV5.py" --plotThePieces --plotTheAverage --exp=$EXP $BLOCKSELECTOR $WINDOW $ANALYSISFOLDER $ALIGNFOLDER $INPUTBLOCKNAME $UNITSELECTOR $ALIGNQUERY
  #
