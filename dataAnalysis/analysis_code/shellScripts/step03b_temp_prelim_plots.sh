...
do
  ...
  # python -u './plotSignalDataFrameV2.py' --plotSuffix="lfp_hf_illustration_topo" --verbose=1 --selectionName="lfp" $OPTS --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}"
  ...
  python -u './plotSignalDataFrameV2.py' --plotSuffix="laplace_hf_illustration" --verbose=1 --selectionName="laplace" $OPTS --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}"
done