...
# python -u './calcLaplacianFromTriggered.py' --plotting --recalcKCSDCV --useKCSD --inputBlockSuffix="lfp" --unitQuery="lfp" --outputBlockSuffix="kcsd" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR $OUTLIERMASK $LAZINESS
...
# python -u './calcSignalDimensionality.py' --inputBlockSuffix="kcsd" --unitQuery="lfp" --estimatorName="pca_csd" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR --plotting
...
python -u './calcPartialLeastSquares.py' --rhsBlockSuffix="kcsd" --unitQueryRhs="lfp" --lhsBlockSuffix="rig" --unitQueryLhs="lfp" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR --plotting