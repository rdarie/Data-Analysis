...
# Specify a job name:
#SBATCH -J test_train_assembler_normalization_27

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_assembler_normalization_27.out
#SBATCH -e ../../batch_logs/test_train_assembler_normalization_27.out
