...
do
  ...
  # 
  ###########BLOCK_ID_NO="_*"
  ###########python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}*_na_*.pickle" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ###########python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}*_na.h5" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ###########python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}*_na_*_meta.pickle" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  # 
  ...
  # python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_rauc_iterator_*.pickle" --fromDataToScratch --filesIncluded ${KEYPROMPT}
