...
# Specify a job name:
#SBATCH -J s07a_ols_post_impulses_td_rc_202101_22

# Specify an output file
#SBATCH -o ../../batch_logs/regression/s07a_ols_post_impulses_td_rc_202101_22.out
#SBATCH -e ../../batch_logs/regression/s07a_ols_post_impulses_td_rc_202101_22.out
