...
# Specify a job name:
#SBATCH -J s09_regression_state_space_stb_202101

# Specify an output file
#SBATCH -o ../../batch_logs/regression/s09_regression_state_space_stb_202101.out
#SBATCH -e ../../batch_logs/regression/s09_regression_state_space_stb_202101.out
