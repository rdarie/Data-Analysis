...
# Specify a job name:
#SBATCH -J apply_spectral_norm_stim_lfp_21

# Specify an output file
#SBATCH -o ../../batch_logs/apply_spectral_norm_stim_lfp_21-%a.out
#SBATCH -e ../../batch_logs/apply_spectral_norm_stim_lfp_21-%a.out
