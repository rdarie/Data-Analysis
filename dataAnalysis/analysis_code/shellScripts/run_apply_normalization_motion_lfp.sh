...
# Specify a job name:
#SBATCH -J apply_spectral_norm_motion_lfp_25

# Specify an output file
#SBATCH -o ../../batch_logs/apply_spectral_norm_motion_lfp_25-%a.out
#SBATCH -e ../../batch_logs/apply_spectral_norm_motion_lfp_25-%a.out
