...
# Specify a job name:
#SBATCH -J s02c_tts_plots_stim_202101_21

# Specify an output file
#SBATCH -o ../../batch_logs/s02c_test_train_split_plots_stim_202101_21-%a.out
#SBATCH -e ../../batch_logs/s02c_test_train_split_plots_stim_202101_21-%a.out
