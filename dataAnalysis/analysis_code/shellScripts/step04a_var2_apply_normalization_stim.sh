...
# Specify a job name:
#SBATCH -J s04a_tts_covariance_stim_202101_27

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s04a_tts_covariance_stim_202101_27-%a.out
#SBATCH -e ../../batch_logs/covariance/s04a_tts_covariance_stim_202101_27-%a.out
