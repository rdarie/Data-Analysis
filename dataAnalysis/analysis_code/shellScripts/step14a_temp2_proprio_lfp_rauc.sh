...
# Specify a job name:
#SBATCH -J s14a_temp_mahal_dist_rauc_202101_21

# Specify an output file
#SBATCH -o ../../batch_logs/covariance/s14a_temp_mahal_dist_rauc_202101_21.out
#SBATCH -e ../../batch_logs/covariance/s14a_temp_mahal_dist_rauc_202101_21.out
...
do
  ...
  # --plotTheAverage
  python -u "./calcSignalRecruitmentV4.py" --iteratorSuffix=$ITERATOR --plotting --exp=$EXP $BLOCKSELECTOR $WINDOW $ANALYSISFOLDER --loadFromFrames --datasetName="Block_${WINDOWTERM}_df_${ITERATOR}" --selectionName=$TARGET
  python -u "./plotSignalRecruitmentV4.py" --plotTheAverage --plotThePieces --exp=$EXP $BLOCKSELECTOR $WINDOW $ANALYSISFOLDER $ALIGNFOLDER $INPUTBLOCKNAME $UNITSELECTOR $ALIGNQUERY
  #
