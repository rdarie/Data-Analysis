...
# Specify a job name:
#SBATCH -J s04d_tts_regression_motion_201901_27

# Specify an output file
#SBATCH -o ../../batch_logs/s04d_tts_regression_motion_201901_27-%a.out
#SBATCH -e ../../batch_logs/s04d_tts_regression_motion_201901_27-%a.out
