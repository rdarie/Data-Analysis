...
# Specify a job name:
#SBATCH -J s04c_tts_regression_stim_201901_27

# Specify an output file
#SBATCH -o ../../batch_logs/s04c_tts_regression_stim_201901_27-%a.out
#SBATCH -e ../../batch_logs/s04c_tts_regression_stim_201901_27-%a.out
