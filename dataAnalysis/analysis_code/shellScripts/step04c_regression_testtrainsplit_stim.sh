...
# Specify a job name:
#SBATCH -J s04c_tts_regression_ra_stim_202101_27

# Specify an output file
#SBATCH -o ../../batch_logs/regression/s04c_tts_regression_ra_stim_202101_27-%a.out
#SBATCH -e ../../batch_logs/regression/s04c_tts_regression_ra_stim_202101_27-%a.out
