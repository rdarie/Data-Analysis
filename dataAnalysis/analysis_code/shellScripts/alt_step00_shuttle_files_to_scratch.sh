...
exps=(exp202101271100 exp202101281100)
for EXP in "${exps[@]}"
do
  ...
  # after step 2
  BLOCK_ID_NO="0*"
  python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_lfp_${WINDOW}.nix" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ## ## python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_lfp_CAR_${WINDOW}.nix" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  # python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_lfp_spectral_${WINDOW}.nix" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  #
  # after step 3
  # 
  # BLOCK_ID_NO="*"
  ...
  ##   # #  # python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="ols2_*_${ITER}_*.h5" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ##   # #  # python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="ols2_*_${ITER}_meta.pickle" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ...
  ## ## python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_${WINDOW}_outliers.nix" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ## ## python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_${WINDOW}_outliers.h5" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  ## ## python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_${WINDOW}_outliers.csv" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  python './shuttleFilesToFromScratch.py' --exp=$EXP --searchTerm="Block${BLOCK_ID_NO}_epochs.nix" --fromDataToScratch --filesIncluded ${KEYPROMPT}
  # #
