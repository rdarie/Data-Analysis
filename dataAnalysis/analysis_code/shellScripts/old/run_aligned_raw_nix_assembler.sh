...
# Specify a job name:
#SBATCH -J nix_assembly_202101_raw_21

# Specify an output file
#SBATCH -o ../../batch_logs/nix_assembly_raw_202101_21.out
#SBATCH -e ../../batch_logs/nix_assembly_raw_202101_21.out
...
do
  ...
  TIMEWINDOWOPTS="--winStart=-200 --winStop=150"
