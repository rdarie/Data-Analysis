...
# Specify a job name:
#SBATCH -J tts_regression_stim_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/regression/test_train_split_regression_stim_202101_20-%a.out
#SBATCH -e ../../batch_logs/regression/test_train_split_regression_stim_202101_20-%a.out
