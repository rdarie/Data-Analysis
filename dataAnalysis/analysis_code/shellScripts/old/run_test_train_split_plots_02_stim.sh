...
# Specify a job name:
#SBATCH -J tts_plots_02_stim_202101_20

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_split_plots_02_stim_202101_20-%a.out
#SBATCH -e ../../batch_logs/test_train_split_plots_02_stim_202101_20-%a.out
