...
# Specify a job name:
#SBATCH -J tts_assembler_plots_202101

# Specify an output file
#SBATCH -o ../../batch_logs/test_train_split_assembler_plots_202101.out
#SBATCH -e ../../batch_logs/test_train_split_assembler_plots_202101.out
...
do
  ...
  python -u './assembleDataFrames.py' --inputBlockSuffix="lfp_CAR" --resetHDF --selectionName="lfp_CAR" $COMMONOPTS
