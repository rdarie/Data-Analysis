...
# Specify a job name:
#SBATCH -J s04a_apply_norm_stim_201902_04

# Specify an output file
#SBATCH -o ../../batch_logs/s04a_apply_norm_stim_201902_04-%a.out
#SBATCH -e ../../batch_logs/s04a_apply_norm_stim_201902_04-%a.out
