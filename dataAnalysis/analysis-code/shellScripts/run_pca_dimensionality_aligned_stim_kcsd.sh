...
python -u './calcSignalDimensionality.py' --inputBlockSuffix="kcsd" --unitQuery="lfp" --estimatorName="pca_lapl" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR
python -u './calcSignalDimensionality.py' --inputBlockSuffix="lfp_CAR" --unitQuery="lfp" --estimatorName="pca_car" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR
