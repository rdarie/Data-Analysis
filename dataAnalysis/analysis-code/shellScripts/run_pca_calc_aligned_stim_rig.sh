...
python -u './calcTestTrainSplit.py' --inputBlockSuffix="rig" --unitQuery="jointAngle" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR $OUTLIERMASK --calcTimeROI --eventName='stim' --eventBlockSuffix='epochs' --ROIWinStart=200 --ROIWinStop=200
python -u './calcSignalDimensionality.py' --inputBlockSuffix="rig" --unitQuery="jointAngle" --estimatorName="pca_jointAngles" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR
