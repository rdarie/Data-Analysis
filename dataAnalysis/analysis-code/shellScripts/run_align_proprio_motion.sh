...
python3 ./calcAlignedAsigs.py --exp=$EXP $TRIALSELECTOR $LAZINESS $WINDOW $ALIGNSELECTOR --chanQuery="rig" --outputBlockName="rig" --verbose
python3 ./calcAlignedAsigs.py --exp=$EXP $TRIALSELECTOR $LAZINESS $WINDOW $ALIGNSELECTOR --chanQuery="fr" --outputBlockName="fr" --verbose
python3 ./calcAlignedRasters.py --exp=$EXP $TRIALSELECTOR $LAZINESS $WINDOW $ALIGNSELECTOR --chanQuery="raster" --outputBlockName="raster" --verbose
# qa
