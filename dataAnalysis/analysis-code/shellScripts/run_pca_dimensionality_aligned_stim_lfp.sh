...
python -u './calcSignalDimensionality.py' --inputBlockSuffix="lfp" --unitQuery="lfp" --estimatorName="pca_lfp" --exp=$EXP $WINDOW $ALIGNQUERY $ANALYSISFOLDER $ALIGNFOLDER $BLOCKSELECTOR
