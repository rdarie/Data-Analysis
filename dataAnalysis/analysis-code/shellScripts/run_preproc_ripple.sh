...
# Specify a job name:
#SBATCH -J ripple_preproc_20200903_raw

# Specify an output file
#SBATCH -o ../../batch_logs/%j-%a-ripple_preproc_20200903_raw.stdout
#SBATCH -e ../../batch_logs/%j-%a-ripple_preproc_20200903_raw.errout
