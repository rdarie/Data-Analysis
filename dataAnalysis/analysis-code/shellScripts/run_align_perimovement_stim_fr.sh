...
# Specify a job name:
#SBATCH -J alignMotionStim_20201217_fr

# Specify an output file
#SBATCH -o ../../batch_logs/%j_%a_alignMotionStim_20201217_fr.stdout
#SBATCH -e ../../batch_logs/%j_%a_alignMotionStim_20201217_fr.errout
