def getExpOpts():
    ...
    experimentName = '202009031500-Peep'
    deviceName = None
    rippleMapFile = {
    ...
    synchInfo['delsys'][1] = {'timeRanges': [13.9, 1156.9], 'chooseCrossings': slice(None)}  #########
    synchInfo['delsys'][2] = {'timeRanges': [14.5, 550.5], 'chooseCrossings': slice(None)}
    synchInfo['delsys'][3] = {'timeRanges': [29.9, 1766.9], 'chooseCrossings': slice(None)}
    #
    synchInfo['nsp'][1] = {'timeRanges': [23.3, 1166.3], 'chooseCrossings': slice(None)}
    synchInfo['nsp'][2] = {'timeRanges': [4.5, 540.5], 'chooseCrossings': slice(None)}
    synchInfo['nsp'][3] = {'timeRanges': [23.5, 1760.5], 'chooseCrossings': slice(None)}
