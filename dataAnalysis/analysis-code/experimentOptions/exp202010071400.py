def getExpOpts():
    ...
    experimentName = '202010071400-Peep'
    deviceName = None
    rippleMapFile = {
    ...
    synchInfo['delsys'][1] = {'timeRanges': [79, 806], 'chooseCrossings': slice(None)}
    synchInfo['nsp'][1] = {'timeRanges': [89, 814], 'chooseCrossings': slice(None)}
