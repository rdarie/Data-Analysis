...
python3 './plotAlignedAsigs.py' --exp=$EXP --processAll --window="long" --inputBlockName=$BLOCKNAME --unitQuery="rig" --alignQuery="midPeakWithStim100HzCW" --rowName="pedalSizeCat"
